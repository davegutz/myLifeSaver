...
def plot_taylor_life_exp_non_taylor(this_life: "TaylorLife", show: bool = True) -> None:
    ...
    axis_top.plot(dates, this_life.exp_norm_total_lc, linewidth=4.0, label="exp_norm_total_lc")
    axis_top.plot(dates, this_life.worth_norm_lc_history, linewidth=2.0, label="worth_norm_lc")
    axis_top.plot(dates, this_life.worth_norm_cc_history, linewidth=2.0, label="worth_norm_cc")
    axis_top.plot(dates, this_life.earn_norm_lc_history, linewidth=2.0, label="earn_norm_lc")
    axis_top.plot(dates, this_life.earn_norm_cc_history, linewidth=2.0, label="earn_norm_cc")

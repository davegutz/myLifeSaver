...
CONSTANT_MONTHLY_SURCHARGES_CC = 0.  # TBD
CONSTANT_MONTHLY_SURCHARGES_LC = 150.  # Cable
ENTRANCE_FEE_CC_REFUND_INITIAL_FRACTION = 0.80   # CC refund starts at 80% of entrance fee
ENTRANCE_FEE_CC_REFUND_DECAY_RATE = 0.20          # CC refund decays 20% per year
ENTRANCE_FEE_LC_REFUND_INITIAL_FRACTION = 0.90   # LC refund starts at 90% of entrance fee
ENTRANCE_FEE_LC_REFUND_DECAY_RATE = 0.00          # LC refund decays 0% per year
P_MAN_AL = 0.7
P_WOMAN_AL = 0.7

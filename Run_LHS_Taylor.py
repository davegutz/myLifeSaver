...
CSV_COLUMNS = [
    ...
    "earning_potential",      # col 7 – (PILE_AT_START - entrance_fee_lc) * (roi_cum[-1] / cpi_cum[-1]) * elapsed_time_yrs
    "earning_potential_cc",   # col 8 – (PILE_AT_START - entrance_fee_cc) * (roi_cum[-1] / cpi_cum[-1]) * elapsed_time_yrs
...
def summarize_lhs_run(
    ...
    return LhsScenarioSummary(
        ...
        exp_norm_al_lc=last_value(model.exp_norm_al_lc),
        ...
        cum_mo_exp_al_lc_norm=last_value(model.cum_mo_exp_al_lc_norm),
